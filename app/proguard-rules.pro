...
#---------------------------------实体类---------------------------------
#修改成你对应的包名
-keep class com.xh.xiaoshuo.bean.** { *; }
-keep class com.qy.reader.common.entity.** { *; }
-keep class com.xh.baselibrary.bean.** { *; }
...
#下面中括号的地方需要要填你的包名
-keep public class com.yx.jjs.R$*{
...
-keep class com.yx.jjs.view.StarView
-keep class com.xh.baselibrary.view.**
...
#-keep com.xh.baselibrary.ApiException
-ignorewarnings # 抑制警告

-keep class com.qy.reader.crawler.** { *; }
#mob
-keep class com.mob.**{*;}
