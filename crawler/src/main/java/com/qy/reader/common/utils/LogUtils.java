...
public final class LogUtils {
    ...
    private static String sGlobalTag = "qy-reader";  // log 标签
    ...
    private static void printDeviceInfo(final String filePath) {
        ...
        int versionCode = 0;
        try {
            PackageInfo pi = Global.getApplication()
                    .getPackageManager()
                    .getPackageInfo(Global.getApplication().getPackageName(), 0);
            if (pi != null) {
    ...
    public static class Config {
        private Config() {
            ...
            if (Environment.MEDIA_MOUNTED.equals(Environment.getExternalStorageState())
                    && Global.getApplication().getExternalCacheDir() != null)
                sDefaultDir = Global.getApplication().getExternalCacheDir() + FILE_SEP + "log" + FILE_SEP;
            else {
                sDefaultDir = Global.getApplication().getCacheDir() + FILE_SEP + "log" + FILE_SEP;
            }
        }
