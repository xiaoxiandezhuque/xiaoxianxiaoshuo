...
import com.qy.reader.crawler.R;
...
public class PageFactory {
    ...
    private int backGroundColor = Color.parseColor("#e2edd6");
    ...
    public PageFactory() {
        ...
        mTitlePaint.setColor(Color.parseColor("#968c81"));
        mTextPaint.setColor(mTextColor = Color.parseColor("#363e2c"));
    ...
    public void initColor(int backGroundColor, int titleColor, int textColor) {
    ...
    public synchronized void drawCurPage(Canvas canvas, @DrawPageType int drawPage) {
        ...
        try {
            ...
            canvas.drawText(time, mScreenWidth - marginWidth - mTitlePaint.measureText(time), y, mTitlePaint);
    ...
    public boolean getHasNextPage() {
        ...
        return chapters.size() > currentChapter ? true : false;
    }

    public boolean getLastPagePage() {
        if (chapters == null) {
            return false;
        }
        return currentChapter - 2 > 0 ? true : false;
    }
    ...
    public void setTextSpacint(int spacing) {
        initLineSpace(spacing);
    ...
    public void setBgAndTextColor(String bgColor, String textColor, String titleColor) {
        backGroundColor = Color.parseColor(bgColor);
        mTextPaint.setColor(Color.parseColor(textColor));
        mTitlePaint.setColor(Color.parseColor(titleColor));
